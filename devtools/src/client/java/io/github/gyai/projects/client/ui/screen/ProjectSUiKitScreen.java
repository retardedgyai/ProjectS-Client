...
public final class ProjectSUiKitScreen extends ProjectSThemedScreen {
    private static final int HEADER_HEIGHT = DevToolsUiKitLayout.headerHeight();
    private static final int FOOTER_HEIGHT = DevToolsUiKitLayout.footerHeight();
    ...
    protected void init() {
        ...
        if (columns == 1) {
            ...
            y = section("Buttons", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.BUTTONS, narrow));
            y = section("Icon Gallery", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.ICON_GALLERY, narrow));
            y = section("Inputs", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.INPUTS, narrow));
            y = section("Navigation", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.NAVIGATION, narrow));
            y = section("Cards & Badges", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.CARDS, narrow));
            y = section("Feedback", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.FEEDBACK, narrow));
            y = section("Theme Cards", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.THEMES, narrow));
            section("Color Tokens / Spacing", panelX, y, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.TOKENS, narrow));
        } else {
            int leftX = panelX;
            int rightX = panelX + columnWidth + gap;
            int leftY = 0;
            leftY = section("Buttons", leftX, leftY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.BUTTONS, false));
            leftY = section("Inputs", leftX, leftY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.INPUTS, false));
            leftY = section("Feedback", leftX, leftY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.FEEDBACK, false));
            section("Theme Cards", leftX, leftY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.THEMES, false));
            int rightY = 0;
            rightY = section("Icon Gallery", rightX, rightY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.ICON_GALLERY, false));
            rightY = section("Navigation", rightX, rightY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.NAVIGATION, false));
            rightY = section("Cards & Badges", rightX, rightY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.CARDS, false));
            section("Color Tokens / Spacing", rightX, rightY, columnWidth,
                    sectionHeight(DevToolsUiKitLayout.Section.TOKENS, false));
        }
        contentHeight = DevToolsUiKitLayout.contentHeight(width);
    ...
    private static int sectionHeight(
            DevToolsUiKitLayout.Section section, boolean narrow
    ) {
        return DevToolsUiKitLayout.sectionHeight(section, narrow);
    }
