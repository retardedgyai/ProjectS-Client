...
public final class ProjectSUiLogicTest {
    ...
    private static void iconRegistryAtlasTintAndSearch() {
        ...
        assert galleryHeight + 42
                <= ProjectSUiLayout.uiKitSectionHeight(
                ProjectSUiLayout.UiKitSection.ICON_GALLERY, false);
        ...
        assert ProjectSIconGalleryLayout.contentHeight(
                ...
                <= ProjectSUiLayout.uiKitSectionHeight(
                ProjectSUiLayout.UiKitSection.ICON_GALLERY, true);
    ...
    private static void placementAndResponsiveLayout() {
        ...
        assert ProjectSUiLayout.uiKitViewportHeight(529) == 429;
        assert ProjectSUiLayout.uiKitHeaderHeight()
                + ProjectSUiLayout.uiKitViewportHeight(529)
                == 529 - ProjectSUiLayout.uiKitFooterHeight();
        int uiKitContentHeight = ProjectSUiLayout.uiKitContentHeight(960);
        assert uiKitContentHeight == 1120;
        int uiKitMaxScroll = ProjectSUiLayout.maxScroll(
                uiKitContentHeight, ProjectSUiLayout.uiKitViewportHeight(529));
        int finalSectionBottom = ProjectSUiLayout.uiKitHeaderHeight() + 6
                + (uiKitContentHeight - 12) - uiKitMaxScroll;
        assert finalSectionBottom <= 529 - ProjectSUiLayout.uiKitFooterHeight();
